...
// Khởi tạo biến đếm số lượng đơn hàng
var orderCount = 0;

// Kiểm tra nếu có số lượng đơn hàng được lưu trong Local Storage
if (localStorage.getItem('orderCount')) {
  // Lấy số lượng đơn hàng từ Local Storage
  orderCount = parseInt(localStorage.getItem('orderCount'));
...
buyButton.addEventListener('click', function(event) {
  ...
  // Lưu số lượng đơn hàng vào Local Storage
